...
My Summer SLAM presentation on the superalloys project was one of 14 selected for a special presentation to the [Livermore Lab Foundation](https://livermorelabfoundation.org/){:target="_blank"}.
